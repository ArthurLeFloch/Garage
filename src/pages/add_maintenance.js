...
function updateTotalPrice() {
    ...
    fetch("handle_get_new_maintenance_price.php", {
        method: "POST",
...
export function load() {
    ...
    document.getElementById("addMaintenance").addEventListener("click", function (event) {
        ...
        fetch("handle_add_maintenance.php", {
            method: "POST",
            body: JSON.stringify(postData),
            headers: { "Content-Type": "application/json" }
        })
